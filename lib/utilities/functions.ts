...
export default class Functions {
    ...
    public generatePrimaryMessage(
        ...
        return {
            embeds: [
                new EmbedBuilder(embedInfo).setColor(
    ...
    /**
     * Upload content to Sourcebin, it even auto-detects the language!
    ...
    public async uploadHaste(
        ...
        try {
            const haste = await sourcebin.create(
                [
                    {
                        content: content,
                    },
                ...
                {
                    title: 'Bot Auto-Uploader',
                    description: `This is an auto-uploaded file.`,
                },
            );
            return haste.url;
        } catch (error) {
     ...
     */
    public getPermissionName(permission: PermissionsString): string {
